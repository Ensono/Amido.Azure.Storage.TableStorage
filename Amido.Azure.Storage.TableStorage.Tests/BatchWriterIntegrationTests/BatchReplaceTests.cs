...
namespace Amido.Azure.Storage.TableStorage.Tests.BatchWriterIntegrationTests
{
    ...
    public class BatchReplaceTests : BatchWriterTestBase
    {
        ...
        public void Should_Replace_Multiple_Batches_Accross_Partitions()
        {
            ...
            Repository.BatchWriter.Replace(testEntities);
        ...
        [TestMethod]
        public void Should_Fail_Replace_First_Batch_When_New_Entities_Included()
        {
        ...
        [TestMethod]
        public void Should_Fail_Replace_Subsequent_Batch_When_New_Entities_Included()
        {
